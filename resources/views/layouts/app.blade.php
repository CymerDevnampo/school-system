...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/papsystem/assets/plugins/simple-calendar/simple-calendar.css') }}">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="/home" class="logo">
                    {{-- <img src="{{ asset('/papsystem/assets/img/logo.png') }}" alt="Logo"> --}}
                    <img src="{{ asset('/papsystem/assets/img/paplogo.jpg') }}" alt="Logo"><strong
                        class="text-black"> PAP CYMER</strong>
                </a>
                <a href="/home" class="logo logo-small">
                    <img src="{{ asset('/papsystem/assets/img/paplogo.jpg') }}" alt="Logo" width="30"
                        height="30">
                </a>
            </div>
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown noti-dropdown language-drop me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="{{ asset('/papsystem/assets/img/icons/header-icon-01.svg') }}" alt="">
                    </a>
                ...
                <li class="nav-item dropdown noti-dropdown me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="{{ asset('/papsystem/assets/img/icons/header-icon-05.svg') }}" alt="">
                    </a>
                                ...
                                <li class="notification-message">
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar avatar-sm flex-shrink-0">
                                                <img class="avatar-img rounded-circle" alt="User Image"
                                                    src="{{ asset('/papsystem/assets/img/profiles/avatar-11.jpg') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar avatar-sm flex-shrink-0">
                                                <img class="avatar-img rounded-circle" alt="User Image"
                                                    src="{{ asset('/papsystem/assets/img/profiles/avatar-17.jpg') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar avatar-sm flex-shrink-0">
                                                <img class="avatar-img rounded-circle" alt="User Image"
                                                    src="{{ asset('/papsystem/assets/img/profiles/avatar-13.jpg') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                ...
                <li class="nav-item zoom-screen me-2">
                    <a href="#" class="nav-link header-nav-list win-maximize">
                        <img src="{{ asset('/papsystem/assets/img/icons/header-icon-04.svg') }}" alt="">
                    </a>
                </li>
                    ...
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle"
                                src="{{ asset('/papsystem/assets/img/profiles/avatar-01.jpg') }}" width="31"
                                alt="Soeng Souy">
                            <div class="user-text">
                                @if (Route::has('login'))
                                    @auth
                    ...
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="{{ asset('/papsystem/assets/img/profiles/avatar-01.jpg') }}"
                        ...
                        <a class="dropdown-item" href="/p">My Profile</a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu {{ request()->is('home', 'teacher', 'student') ? 'active' : '' }}">
                            <a href="#"><i class="feather-grid"></i> <span> Dashboard</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="/home" class="{{ request()->is('home') ? 'active' : '' }}">Admin
                                        Dashboard</a></li>
                                <li><a href="/teacher" class="{{ request()->is('teacher') ? 'active' : '' }}">Teacher
                                        Dashboard</a></li>
                                <li><a href="/student" class="{{ request()->is('student') ? 'active' : '' }}">Student
                                        Dashboard</a></li>
                            </ul>
                        </li>

                        <li class="submenu {{ request()->is('list', 'student-add/create', '#', 'edit/*') ? 'active' : '' }}">
                            <a href="#"><i class="fas fa-graduation-cap"></i> <span> Students</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="/list" class="{{ request()->is('list') ? 'active' : '' }}">Student List</a></li>
                                <li><a href="/student-add/create" class="{{ request()->is('student-add/create') ? 'active' : '' }}">Student Add</a></li>
                                <li><a href="#" class="{{ request()->is('#') ? 'active' : '' }}">Student View</a></li>
                                @if(request()->is('edit/*'))
                                    <li id="studentEditLink"><a href="/edit" class="{{ request()->is('edit/*') ? 'active' : '' }}">Student Edit</a></li>
                                @else
                                    <li id="studentEditLink" style="display: none;"><a href="/edit" class="{{ request()->is('edit*') ? 'active' : '' }}">Student Edit</a></li>
                                @endif
                            </ul>
                        </li>                        
        ...
        <div class="page-wrapper">
            ...
            <footer>
                <p>Copyright © 2024 Professional Academy of the Philippines. <img width="20"
                        src="{{ asset('/papsystem/assets/img/paplogo.jpg') }}"></p>
            </footer>
        </div>
    </div>
    ...
    <script src="{{ asset('/papsystem/assets/plugins/simple-calendar/jquery.simple-calendar.js') }}"></script>
    <script src="{{ asset('/papsystem/assets/js/calander.js') }}"></script>
    <script src="{{ asset('/papsystem/assets/js/circle-progress.min.js') }}"></script>
