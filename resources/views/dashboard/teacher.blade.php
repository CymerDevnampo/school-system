                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{ asset('/papsystem/assets/img/icons/teacher-icon-01.svg') }}"
                                    alt="Dashboard Icon">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{ asset('/papsystem/assets/img/icons/teacher-icon-02.svg') }}"
                                    alt="Dashboard Icon">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{ asset('/papsystem/assets/img/icons/teacher-icon-03.svg') }}"
                                    alt="Dashboard Icon">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card flex-fill comman-shadow">
                            ...
                            <div class="dash-widget">
                                <div class="circle-bar circle-bar1">
                                    <div class="circle-graph1" id="circle" data-percent="Auth::user()->progessbar">
                                            ...
                                            <div class="dolor-activity">
                                                ...
                                                <ul class="teacher-date-list">
                                                    <li><i class="fas fa-calendar-alt me-2"></i>September 5,
                                                        2022</li>
                                                    <li>|</li>
                                                    <li><i class="fas fa-clock me-2"></i>09:00 am - 10:00 am
                                                        (60
                                                        Minutes)</li>
                                                </ul>
                                            </div>
                                            <div class="activity-btns ms-auto">
                                                <button type="submit" class="btn btn-info">In
                                                    Progress</button>
                                            </div>
                                        </li>
                                        <li class="feed-item d-flex align-items-center">
...
@push('js')
    {{-- <script>
        $(document).ready(function() {
            var userProgress = {{ Auth::user()->progress }}; // Assuming 'progress' is the field in the user's database

            $('#circle').circleProgress({
                value: userProgress / 100, // Assuming the progress is a percentage
                size: 500,
                fill: {
...
Make sure you have the Auth facade imported at the top of your file, like so:
...
@endphp
This script will dynamically set the value of the circle based on the user's progress in the database. Adjust the field
name (progress in this case) according to your database structure. --}}
