                ...
                <div class="card comman-shadow">
                    <div class="card-body">
                        <form method="post" action="/student/{{ $student->id }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title student-info">Edit Student Information <span><a
                                                href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>First Name <span class="login-danger">*</span></label>
                                        <input id="name" name="name" value="{{ old('name') ?? $student->name }}"
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input id="lastname" name="lastname"
                                            value="{{ old('lastname') ?? $student->lastname }}" autocomplete="name"
                                            autofocus class="form-control @error('lastname') is-invalid @enderror"
                                            type="text">
                                        @error('lastname')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input id="address" name="address"
                                            value="{{ old('address') ?? $student->address }}" autocomplete="name" autofocus
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input id="email" name="email" value="{{ old('email') ?? $student->email }}"
                                            autocomplete="name" autofocus
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select id="gender" name="gender" autocomplete="name" autofocus
                                            ...
                                            <option value="{{ old('gender') ?? $student->gender }}" selected>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Age </label>
                                        <input id="age" name="age" value="{{ old('age') ?? $student->age }}"
                                            autocomplete="name" autofocus
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input id="phone" name="phone"
                                            value="{{ old('phone') ?? $student->phone }}" autocomplete="name" autofocus
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select id="religion" name="religion" autocomplete="name" autofocus
                                            ...
                                            <option value="{{ old('religion') ?? $student->religion }}" selected>
                                    ...
                                    <div class="form-group local-forms">
                                        ...
                                        <select id="course" name="course" autocomplete="name" autofocus
                                            ...
                                            <option value="{{ old('course') ?? $student->course }}" selected>
                                                {{ old('course') ?? $student->course }}</option>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select id="year" name="year" autocomplete="name" autofocus
                                            ...
                                            <option value="{{ old('year') ?? $student->year }}" selected>
                                                {{ old('year') ?? $student->year }}</option>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select id="section" name="section" value="{{ old('section') }}"
                                            ...
                                            <option value="{{ old('section') ?? $student->section }}" selected>
                                                {{ old('section') ?? $student->section }}</option>
